...
public class GameConfig {
    ...
    @Bean
    public AuthService authService(UserService userService, JwtProvider jwtProvider, JwtUtil jwtUtil) {
        return new AuthServiceImpl(userService, jwtProvider, jwtUtil);
    }
